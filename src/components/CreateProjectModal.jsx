...
export default function CreateProjectModal({ isOpen, onClose, onSave }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (name.trim().length < 3) {
      setError('Nama project minimal 3 karakter.');
      return;
    }
          ...
          >
            ...
            <div style={s.header}>
              <div style={s.headerLeft}>
                <motion.div
                  ...
                  style={s.colorDot}
                />
                <h3 style={s.title}>Buat Project Baru</h3>
              </div>
            ...
            <form onSubmit={handleSubmit} style={s.form}>
              ...
              <div style={s.inputGroup}>
                <label style={s.label}>Nama Project *</label>
                <input
                  type="text"
                  value={name}
              ...
              {/* Color picker */}
              <div style={s.inputGroup}>
                <label style={s.label}>Warna Tema Project</label>
