...
export default function RegisterPage({ onRegister, theme, onToggleTheme, onSwitchToLogin }) {
    ...
    <div style={styles.wrapper}>
      ...
      <div style={styles.formPanel}>
        <div style={styles.formInner}>
          ...
          <h1 style={styles.heading}>Daftar</h1>
          <p style={styles.subtitle}>Buat akun baru dan mulai kelola tugas Anda.</p>
          ...
          <p style={styles.footerText}>
            Sudah punya akun?{' '}
            <button type="button" onClick={onSwitchToLogin} style={styles.linkBtnInline}>Masuk</button>
          </p>
        </div>
      </div>
